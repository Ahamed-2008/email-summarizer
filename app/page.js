      ...
      <main className="flex min-h-screen flex-col items-center justify-center p-24 bg-gradient-to-br from-indigo-50 via-white to-cyan-50">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <Mail className="w-6 h-6 text-indigo-600 animate-pulse" />
          </div>
        </div>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Transform your inbox with AI-powered email summaries
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 mb-8">
              <div className="flex items-center space-x-3 p-4 bg-white/60 backdrop-blur-sm rounded-xl border border-white/20">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Process hundreds of emails in seconds</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3 p-4 bg-white/60 backdrop-blur-sm rounded-xl border border-white/20">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Smart summaries that capture key insights</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3 p-4 bg-white/60 backdrop-blur-sm rounded-xl border border-white/20">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Your data stays safe with Google OAuth</p>
                </div>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full group relative overflow-hidden bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-semibold py-4 px-8 rounded-2xl transition-all duration-300 transform hover:scale-105 hover:shadow-2xl"
            >
